...
A book author should be able to transfer a non-public book to a moderator for review or moderation before it becomes publicly available.

Actors: Book Author, Moderator

Metadata: Title, Author, Year, Category, Language.
